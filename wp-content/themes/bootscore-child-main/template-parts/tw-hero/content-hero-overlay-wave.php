...
$background_image = $hero_inputs['images']['background_image']['url'] ?? $hero_inputs['images']['background_image'];
$description = $hero_inputs['copy']['description']['desktop'] ?? null;
?>

<?php if (isset($hero_inputs) && !empty($hero_inputs)) { ?>

   <header class="block">
      <div class="min-h-96 relative flex items-center bg-cover bg-center p-0 overflow-hidden" style="background-image: url(<?php echo $background_image; ?>);">
