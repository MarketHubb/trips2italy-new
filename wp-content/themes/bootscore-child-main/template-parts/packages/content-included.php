	...
	<div class="grid grid-cols-1 w-full">
		<div class="p-8 sm:p-10 lg:flex-auto">
			<div class=" flex items-center gap-x-4">
				<h4 class="flex-none stylized inline-block font-normal text-2xl lg:text-4xl text-orange">Plus:</h4>
			...
			<ul role="list" class="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm leading-6 text-gray-600 sm:gap-6">
				...
				<?php foreach ($args as $include) { ?>
					...
					<li class="flex gap-x-3">
						<svg class="h-7 w-6 flex-none text-blue" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
