            ...
            <div class="col-10 mx-auto bg-gradient-dark border-radius-lg">
                <div class="row py-5">
                    ...
                    <div class="col-xl-4 col-md-5 z-index-2 position-relative px-md-3 px-5 my-md-auto mt-4">
                        ...
                        <p class="text-white font-weight-bold text-sm">Carole & George <span class="text-xs font-weight-normal"></span></p>
                        <hr class="vertical start-100 ms-n5 d-xl-block d-none">
                    </div>
                    <div class="col-1"></div>
                    <div class="col-xl-2 col-12 px-xl-0 px-5 my-xl-auto">
                        <h3 class="text-white mt-xl-0 mt-5">2,542 people</h3>
                        <p class="text-sm text-white opacity-8">Have taken the Italian vacation of their dreams this year thanks to Trips 2 Italy</p>
                        <a href="javascript:;" class="text-primary icon-move-right text-sm"  data-bs-toggle="modal" data-bs-target="#modalppc">Be the next
