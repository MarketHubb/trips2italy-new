                ...
                <div class="row">
                    ...
                    <div class="col-xl-5 col-md-8 col-12 text-start">
                        <div class="p-3 text-start border-radius-lg">
                            <h2 class="text-gradient text-info mb-0">Don't just see <?php echo format_region_title($post->ID); ?>, live it.</h2>
                            <h2>Your dream trip to Italy has never been closer</h2>
                            <p class="text-dark text-lg mt-3">
                                ...
                                For being a bright color. Contact us at <a href="javascript:;" class="text-info font-weight-normal">contact@soft.com</a>.</p>
                        </div>
                    </div>
                </div>
                <div class="row bg-warning-soft bottom-0">
                    <div class="row">
                        <div class="col-xl-3 position-relative">
                            <img class="w-100 border-radius-section border-top-start-radius-0 border-bottom-start-radius-0 start-0 position-absolute max-width-300 mt-n11 d-xl-block d-none" src="http://t2i-new.test/wp-content/uploads/2023/01/Italy_Sicily_Food_Tommaso_Eating_Giant_Cannolo_GL01.jpg" alt="image">
                        </div>
                        <div class="col-xl-9">
                            <div class="row">
                                <div class="col-xl-3 col-md-4 py-md-5 py-3">
                                    <div class="p-3 text-start border-radius-lg">
                                        ...
                                        <p class="lead fw-bold text-gradient text-info">ITALY DESTINATIONS</p>
                                        <p>More Italian destinations than any travel site. Do and see more with Trips 2 Italy.</p>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-md-4 py-md-5 py-3">
                                    <div class="p-3 text-start bg-white border-radius-lg shadow-lg">
                                        ...
                                        <p class="lead fw-bold text-info text-gradient">CUSTOM ITINERARIES</p>
                                        <p>Because your dream trip should be designed for <em>you</em> - not for the masses. </p>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-md-4 py-md-5 py-3">
                                    <div class="p-3 text-start border-radius-lg">
                                        ...
                                        <p class="lead fw-bold text-gradient text-info">PEACE OF MIND</p>
                                        <p>From flights and accommodations to food and activities - we handle it all.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <img class="w-10 end-10 position-absolute mt-n6" src="../../assets/img/pattern-points.png" alt="image">
                </div>
            </div>
        </div>
</section>
