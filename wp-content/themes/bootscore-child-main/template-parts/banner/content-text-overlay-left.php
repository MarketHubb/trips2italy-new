...
if ($args) {
    ...
    <header>
        <div class="page-header min-vh-50">
            <div
                class="position-absolute fixed-top ms-auto w-100  z-index-0 d-none d-sm-none d-md-block banner-full-width-text-overlay"
                style="background-image: url(<?php echo $hero['background_image']; ?>);">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 d-flex justify-content-center flex-column">
                        <div class="card card-body blur d-flex justify-content-center shadow-lg p-4 p-md-4 p-lg-5 mt-5">
                            ...
                            <?php
                            $button_copy_array = explode(",",$hero['links_links'][0]['copy']);
                            $desktop_copy = trim($button_copy_array[0]);
                            $mobile_copy = trim($button_copy_array[1]);
