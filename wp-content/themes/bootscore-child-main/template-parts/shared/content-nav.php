...
<header id="masthead" class="site-header">
    <nav class="navbar navbar-expand-xl navbar-light bg-white z-index-3 py-2 fixed-top z-index-3">
        <div class="container">
            <a class="navbar-brand pt-1 pb-2 absolute top-3" href="<?php echo get_home_url(); ?>" rel="tooltip" title="Custom Italian Vacations" data-placement="bottom">
            ...
            <button data-type="Form" data-target="form" class="btn btn-sm d-inline-block d-md-none bg-orange text-white btn-round mb-0 me-1" role="button">Plan My Trip</a>
                ...
                <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0 mt-2 mb-1" id="navigation">
                    ...
                    <ul class="navbar-nav navbar-nav-hover mx-auto">
                        ...
                        if (have_rows('primary_nav', 'option')):
                            ...
                            while (have_rows('primary_nav', 'option')) : the_row();
                                ...
                                $nav .= 'class="' . $active_class . 'nav-link font-bold ps-md-2 d-flex flex-column justify-content-between cursor-pointer align-items-center" role="button">';
                                $nav .= '<img src="' . get_sub_field('icon', 'option') . '" class="max-h-[15px] opacity-20 relative mb-1" />';
