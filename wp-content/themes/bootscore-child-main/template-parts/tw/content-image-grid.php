<?php echo get_section_container_open(); ?>
   <div class="mx-auto max-w-7xl md:px-6 lg:flex lg:px-8">
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
         <div class="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
            <p class="text-base text-brand capitalize">You Deserve</p>
            <h2 class="text-2xl font-bold text-brand-700 sm:text-4xl stylized">A truly one-of-kind honeymoon, designed just for you</h2>
         ...
         <div class="flex flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents">
            <div class="flex-auto lg:ml-auto lg:w-auto lg:flex-none"> 
