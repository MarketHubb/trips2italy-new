...
<!--          <a class="group inline-flex items-center gap-x-2 py-2 px-3 bg-secondary-500 font-semibold text-base text-white rounded-full focus:outline-none hover:bg-secondary-400" href="<?php //echo get_cta_href(); ?>">
