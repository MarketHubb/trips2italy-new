...
<nav
    ...
    <div class="container">
        <a class="navbar-brand" href="<?php echo get_home_url(); ?>" rel="tooltip" title="Custom Italian Vacations" data-placement="bottom" target="_blank">
            Trips 2 Italy
        </a>
        <a href="" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 ms-auto d-lg-none d-block">Plan Our Trip</a>
