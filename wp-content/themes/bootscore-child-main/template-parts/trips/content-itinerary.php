...
<?php if ($global_options) { ?>
    ...
    url(<?php echo $bg_image;
        ...
        <div class="container mx-auto space-y-6 lg:space-y-0 px-0">
            ...
            <ul class="flex lg:grid lg:grid-cols-3 lg:justify-center lg:content-center snap-slider snap-x snap-mandatory gap-x-6 lg:gap-x-8 lg:gap-y-8 py-6 lg:px-8 overflow-x-auto relative bottom-8">
                <!-- <ul class="snap-slider flex snap-x snap-mandatory gap-x-6 pt-6 pb-6 overflow-x-auto"> -->
