...
<section class="py-7">
    ...
    <div class="container">
        ...
        <div class="row"><div class="col-lg-2 col-md-4 col-6 ms-auto"><img class="w-100 opacity-8" src="<?php echo get_home_url(); ?>/wp-content/uploads/2023/06/IATA-Logo.jpg" alt="Logo"></div><div class="col-lg-2 col-md-4 col-6 ms-auto"><img class="w-100 opacity-8" src="<?php echo get_home_url(); ?>/wp-content/uploads/2023/06/NTA-Logo.jpg" alt="Logo"></div><div class="col-lg-2 col-md-4 col-6 ms-auto"><img class="w-100 opacity-8" src="<?php echo get_home_url(); ?>/wp-content/uploads/2023/06/BBB-Logo.jpg" alt="Logo"></div><div class="col-lg-2 col-md-4 col-6 ms-auto"><img class="w-100 opacity-8" src="<?php echo get_home_url(); ?>/wp-content/uploads/2023/06/ENIT-Logo.jpg" alt="Logo"></div><div class="col-lg-2 col-md-4 col-6 ms-auto"><img class="w-100 opacity-8" src="<?php echo get_home_url(); ?>/wp-content/uploads/2023/06/ASTA-Logo.jpg" alt="Logo"></div></div>
    </div>
